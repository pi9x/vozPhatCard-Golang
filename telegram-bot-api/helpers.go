...
// Same like NewInlineKeyboardMarkup but works with a slice of inline keyboard rows.
func NewInlineKeyboardMarkup2(rows [][]InlineKeyboardButton) InlineKeyboardMarkup {
	var keyboard [][]InlineKeyboardButton
